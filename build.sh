...
if [ "$unamestr" = 'Linux' ]; then
   ...
   if [ -f /usr/bin/gnome-terminal ]; then
    ...
    # of overlapping memory whenever i remove something from my dynamic array. 
    #
    # Obviously the fix is to use memmove, but it straight up yeets it out of existance when you
    # turn on optimizations. **Every** other OS doesnt seem to have this problem with my code except
    # this shitty one, (it was a pain to install as well compared to NetBSD and FreeBSD),
    #
