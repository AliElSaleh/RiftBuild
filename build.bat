...
set Defines=-DRIFT_STATIC -DNO_ASSERT -D_NO_CRT_STDIO_INLINE -DRIFTBUILD_VERSION_STRING=\"0.2.0-beta\" -DRIFTBUILD_MAJOR_VERSION=0 -DRIFTBUILD_MINOR_VERSION=1 -DRIFTBUILD_PATCH_VERSION=0
