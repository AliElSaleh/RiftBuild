...
set Libraries=-lkernel32 -luser32 -lshell32 -lole32 -ladvapi32 -lntdll -lshlwapi -lbcrypt -loleaut32 -lmicrosoft_craziness
set LibraryPaths=-LSource\Libraries\Windows

echo Compiling sources (Windows)

clang "Source/Core/Memory.c" "Source/Core/StringUtils.c" "Source/Core/Log.c" "Source/Core/Platform_Core.c" "Source/Core/Platform_Windows.c" "Source/Program.c" "Source/Backend.c" "Source/Parse.c" "Source/Exporter.c" %CompilerFlags% %Defines% %IncludeFlags% -o RiftBuild.exe %LinkerFlags% %LibraryPaths% %Libraries% || goto end
