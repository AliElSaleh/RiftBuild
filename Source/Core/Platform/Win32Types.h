...
///////////////////// strsafe.h /////////////////////
// strsafe.h is over 10,000 lines long which is slow to include
// so just extract the necessary parts we need

#ifdef _M_CEE_PURE
#define STRSAFEAPI      inline HRESULT __clrcall
#else
...
inline HRESULT StringValidateDestA(STRSAFE_PCNZCH pszDest, size_t cchDest, const size_t cchMax)
{
    HRESULT hr = S_OK;
...
inline HRESULT StringValidateDestW(STRSAFE_PCNZWCH pszDest, size_t cchDest, const size_t cchMax)
{
    HRESULT hr = S_OK;
...
inline HRESULT StringLengthWorkerA(STRSAFE_PCNZCH psz, size_t cchMax, size_t* pcchLength)
{
    HRESULT hr = S_OK;
...
inline HRESULT StringLengthWorkerW(STRSAFE_PCNZWCH psz, size_t cchMax, size_t* pcchLength)
{
    HRESULT hr = S_OK;
    size_t cchOriginalMax = cchMax;
...
inline HRESULT StringExValidateDestA(STRSAFE_PCNZCH pszDest, size_t cchDest, const size_t cchMax, DWORD dwFlags)
{
    HRESULT hr = S_OK;
...
inline HRESULT StringValidateDestAndLengthA(STRSAFE_LPCSTR pszDest, size_t cchDest, size_t* pcchDestLength, const size_t cchMax)
{
    HRESULT hr;
...
inline HRESULT StringValidateDestAndLengthW(STRSAFE_LPCWSTR pszDest, size_t cchDest, size_t* pcchDestLength, const size_t cchMax)
{
    HRESULT hr;
...
inline HRESULT StringExValidateDestAndLengthA(STRSAFE_LPCSTR pszDest, size_t cchDest, size_t* pcchDestLength, const size_t cchMax, DWORD dwFlags)
{
    HRESULT hr;
...
inline HRESULT StringCopyWorkerA(STRSAFE_LPSTR pszDest, size_t cchDest, size_t* pcchNewDestLength, STRSAFE_PCNZCH pszSrc, size_t cchToCopy)
{
    HRESULT hr = S_OK;
...
inline HRESULT StringCopyWorkerW(STRSAFE_LPWSTR pszDest, size_t cchDest, size_t* pcchNewDestLength, STRSAFE_PCNZWCH pszSrc, size_t cchToCopy)
{
    HRESULT hr = S_OK;
    size_t cchNewDestLength = 0;
...
STRSAFEAPI StringCchCatA(STRSAFE_LPSTR  pszDest, size_t cchDest, STRSAFE_LPCSTR pszSrc)
{
    ...
    if (SUCCEEDED(hr))
    {
        hr = StringCopyWorkerA(pszDest + cchDestLength, cchDest - cchDestLength, NULL, pszSrc, STRSAFE_MAX_LENGTH);
    }
...
STRSAFEAPI StringCchCatW(STRSAFE_LPWSTR  pszDest, size_t cchDest, STRSAFE_LPCWSTR pszSrc)
{
    ...
    if (SUCCEEDED(hr))
    {
        hr = StringCopyWorkerW(pszDest + cchDestLength, cchDest - cchDestLength, NULL, pszSrc, STRSAFE_MAX_LENGTH);
    }
