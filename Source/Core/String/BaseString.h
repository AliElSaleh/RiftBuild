...
#define StringNStatic(Name, n) 	            struct { char Data[n]; u32 Length; u32 Capacity; } Name = {.Length = 0, .Capacity = (n)-1}
...
#define StrLit(s)                           (const String){.Length = sizeof((s))-1, .Data = (char*)((s)), .Capacity = sizeof((s))-1}
#define Str16Lit(s)                         (const String16){.Length = sizeof((s))-1, .Data = (wchar*)((s)), .Capacity = sizeof((s))-1}
#define StrLitLength(s)                     sizeof((s))-1

#define Str(s)                              (String){.Length = (s).Length, .Data = (s).Data, .Capacity = (s).Capacity}
#define StrView(s)                          (const String){.Length = (s).Length, .Data = (char*)(s).Data, .Capacity = (s).Capacity}
#define StrComp(s, Len)                     (String){.Length = Len, .Data = (s), .Capacity = Len}
#define StrViewComp(s, Len)                 (const String){.Length = Len, .Data = (char*)(s), .Capacity = Len}
#define StrCompC(s, Len, Cap)               (String){.Length = Len, .Data = (s), .Capacity = Cap}
#define StrViewCompC(s, Len, Cap)           (const String){.Length = Len, .Data = (char*)(s), .Capacity = Cap}
#define StrSlice(s, Len)                    (String){.Length = Len, .Data = (s), .Capacity = Len}
...
#define Str16Comp(s, Len)                   (String16){.Length = Len, .Data = (s), .Capacity = Len}
#define Str16ViewComp(s, Len)               (const String16){.Length = Len, .Data = (wchar*)(s), .Capacity = Len}
#define Str16CompC(s, Len, Cap)             (String16){.Length = Len, .Data = (s), .Capacity = Cap}
#define Str16ViewCompC(s, Len, Cap)         (const String16){.Length = Len, .Data = (wchar*)(s), .Capacity = Cap}

#define StrArray(n, Array)                  (StringArray){.List = (String*)(Array), .Num = n}
#define StrViewArray(n, Array)              (const StringArray){.List = (String*)(Array), .Num = n}
#define StrArrayStatic(n, ...)              (StringArray){.List = (String[]){__VA_ARGS__}, .Num = n}
#define StrViewArrayStatic(n, ...)          (const StringArray){.List = (String[]){__VA_ARGS__}, .Num = n}
