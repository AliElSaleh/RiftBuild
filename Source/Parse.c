...
static ReservedKeyTable ReservedKeys[84] =
{
    ...
    { .Key = SC("Apple.Bundle"),              .MaxValueLength = 0,     .Impact = BuildKeyImpact_Relink    },
    { .Key = SC("Apple.Bundle.IsTerminal"),   .MaxValueLength = 0,     .Impact = BuildKeyImpact_Relink    },
    { .Key = SC("Apple.Bundle.InfoPlist"),    .MaxValueLength = 256,   .Impact = BuildKeyImpact_Relink    },
    { .Key = SC("Apple.Bundle.VersionPlist"), .MaxValueLength = 256,   .Impact = BuildKeyImpact_Relink    },
    { .Key = SC("Apple.Bundle.PkgInfo"),      .MaxValueLength = 256,   .Impact = BuildKeyImpact_Relink    },
